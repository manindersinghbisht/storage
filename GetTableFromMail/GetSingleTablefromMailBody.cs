...
{
    [Description("Return Datatable if mailmessage contains any table, suggestion: use has HTML Table activity before this.")]
    public class GetSingleTableFromMailBody : NativeActivity
    {
            [RequiredArgument]
            [Category("Input")]
            ...
            [Category("Input")]
            [Description("Default value of TableNumber is 1, Enter tableNumber if want a specific table from mailbody")]
